...
var BlockManager = module.exports = function () {
    ...
    function queryNetwork() {
        ...
        context.daemon.cmd('getblockcount', [], function(error, response) {
    ...
    function queryBlock(share, callback) {
        context.daemon.cmd('getblock', [share.blockHash], function (error, response) {
            if (response.error)
                callback(false);
            else
    ...
    function submitBlock(share, callback) {
        ...
        context.daemon.cmd(command, args, function (error, response) {
            if (response.error) {
