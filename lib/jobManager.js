...
var JobManager = module.exports = function() {
    ...
    this.extraNonce2Size = context.extraNonce.placeholder.length - this.extraNonceCounter.size;
    ...
    var blockHasher = (function () {
        switch (context.coin.algorithm) {
            case 'scrypt':
                if (context.coin.isProofOfStakeHybrid) {
                    return function (d) {
